...
# This file controls the scope of the dynamica data-flow analysis by declaring the target packages to instrument
# By default java language is instrumented already.
#
# If you know what you are doing, set this manually.
# Note that a broad package-filter (e.g., org., com. ) creates an uncessarily large number of dependencies
