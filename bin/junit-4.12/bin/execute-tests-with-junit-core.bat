...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="execute-tests-with-junit-core" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.junit.runner.LocalJUnitCore %CMD_LINE_ARGS%
