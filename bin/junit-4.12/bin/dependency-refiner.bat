...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="dependency-refiner" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" de.unisaarland.cs.st.cut.refinement.DependencyRefiner %CMD_LINE_ARGS%
