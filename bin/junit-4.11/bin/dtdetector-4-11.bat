...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="dtdetector-4-11" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" de.unisaarland.cs.st.cut.DTDetectorClone %CMD_LINE_ARGS%
