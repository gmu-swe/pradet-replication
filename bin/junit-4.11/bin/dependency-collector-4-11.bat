...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="dependency-collector-4-11" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" de.unisaarland.cs.st.cut.collection.DependencyCollector %CMD_LINE_ARGS%
