...
public class Relationship implements Result {
	...
	public static final String MERGECLEAN = "MERGE";
	public static final String MERGECONFLICT = "CONFLICT";
	public static final String COMPILECONFLICT = "COMPILECONFLICT";
	public static final String TESTCONFLICT = "TESTCONFLICT";
	public static final String PENDING = "PENDING";
	public static final String ERROR = "ERROR";

	// path to the images
	private static final String PATH = "/crystal/client/images/";
	
	// path suffix for 32X32 size images
	private static final String SIZE32 = "32X32/";
	// path suffix for 32X32 size images
	private static final String SIZE16 = "16X16/";

	// path suffix for must icons
	private static final String CAPABLE_MUST = "must/";
	// path suffix for might icons
	private static final String CAPABLE_MIGHT = "might/";
	// path suffix for cannot icons
	private static final String CAPABLE_CANNOT = "cannot/";

//	private static String WHEN_NOW = "must/";
//	private static String WHEN_LATER = "cannot/";

	private static final Map<String, String> ICON_ADDRESSES = new HashMap<String, String>();
	static {
